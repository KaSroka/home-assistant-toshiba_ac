...
class ToshibaClimate(ClimateEntity):
    ...
    async def async_set_temperature(self, **kwargs):
        ...
        if set_temperature < 5 and self._device.ac_merit_a_feature == ToshibaAcFcuState.AcMeritAFeature.SAVE:
            set_temperature = 5
        elif set_temperature < 17 and self._device.ac_merit_a_feature != ToshibaAcFcuState.AcMeritAFeature.SAVE:
            set_temperature = 17
